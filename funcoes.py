...
def doacao():
    ...
    if regiao_doacao == 'sul':
        transporte = int(input('O transporte do alimento será realizado pela sua pessoa ou por uma transportadora?(1 - eu / 2 - transportadora) '))
        if transporte == 1:
        ...
        transporte = int(input('O transporte do alimento será realizado pela sua pessoa ou por uma transportadora? Digite o número(1 - eu / 2 - transportadora) '))
        if transporte == 1:
